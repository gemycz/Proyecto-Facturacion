    ...
    <header id="cabecera" style="background: url(img/banner.png)">
       ...
       <!--MENU-->
        ...
        <div class="registro-producto">
            ...
            <div class="formulario-registro-producto">
              
               <form action="#">
               
                <p>Nombre: </p><br>
                <input type="text" name="nombre_pro">
                <br>
                <p>Código: </p><br>
                <input type="text" name="codigo_pro">
                <br>
                <p>Cantidad: </p><br>
                <input type="number" name="cantidad_pro">
                <br>
                <p>Precio: </p><br>
                <input type="text" name="precio_pro">
                
                <br>
                <input id="enviar2" type="submit">
