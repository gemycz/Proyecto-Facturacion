...
if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
   ...
   header('Location: http://localhost/Proyeto-Facturacion/CRUD/login_php/login.php');//redirige a la página de login si el usuario quiere ingresar sin iniciar sesion
...
session_destroy();
header('Location: http://localhost/Proyeto-Facturacion/CRUD/login_php/login.php');//redirige a la página de login, modifica la url a tu conveniencia
            ...
            <ul>
              ...
              <li><a class="icon-doc-text-inv" href="factura.php">Factura</a></li>
               ...
               <li><a class="icon-doc-text-inv" href="indexPro.php">Lista de Productos</a></li>
          		<li> <p>Bienvenido <?php echo  $_SESSION['username'];?><p></li>
                 
                <li>	<a href="http://localhost/Proyeto-Facturacion/CRUD/login_php/logout.php"><button type="button" class="btn btn-success"> Cerrar Sesion</button></a></li>
                <li><div class="jumbotron text-center">
                </div></li>
